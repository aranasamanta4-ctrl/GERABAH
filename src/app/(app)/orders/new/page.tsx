...
export default async function NewOrderPage() {
  ...
  return (
    <div className="mx-auto max-w-lg p-6 sm:p-8">
      <h1 className="mb-6 font-serif text-2xl font-semibold text-charcoal">Tambah Pesanan</h1>
      ...
      {products.length === 0 ? (
        ...
        <form action={createOrder} className="flex flex-col gap-5 rounded-2xl border border-border bg-card p-6 shadow-sm">
          <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="mb-1 block text-sm text-charcoal/70">Harga (Rp)</label>
              <input
                name="price"
                type="number"
                min={0}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="mb-1 block text-sm text-charcoal/70">DP (Rp)</label>
              <input
                name="downPayment"
                type="number"
                min={0}
          ...
          <div>
            <label className="mb-1 block text-sm text-charcoal/70">Jatuh Tempo</label>
            <input
              name="dueDate"
              type="date"
              className="w-full rounded-lg border border-border bg-white px-3 py-2 text-sm outline-none focus:border-terracotta"
          ...
          <div>
            <label className="mb-1 block text-sm text-charcoal/70">Channel</label>
            <input
              name="channel"
